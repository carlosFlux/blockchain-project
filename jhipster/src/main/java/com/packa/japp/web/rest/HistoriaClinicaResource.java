...
public class HistoriaClinicaResource {
	 ...
	 *            the historiaClinicaDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the new
	 *         historiaClinicaDTO, or with status 400 (Bad Request) if the
	 *         historiaClinica has already an ID
	 ...
	 *
	 * @param historiaClinicaDTO
	 *            the historiaClinicaDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         historiaClinicaDTO, or with status 400 (Bad Request) if the
	 *         historiaClinicaDTO is not valid, or with status 500 (Internal Server
	 *         Error) if the historiaClinicaDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/historia-clinicas")
	@Timed
	public ResponseEntity<HistoriaClinicaDTO> updateHistoriaClinica(@RequestBody HistoriaClinicaDTO historiaClinicaDTO)
			throws URISyntaxException {
	 ...
	 *
	 * @param id
	 *            the id of the historiaClinicaDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         historiaClinicaDTO, or with status 404 (Not Found)
	 */
	 ...
	 *
	 * @param id
	 *            the id of the historiaClinicaDTO to delete
