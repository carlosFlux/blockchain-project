...
public class SintomaResource {
	 ...
	 *
	 * @param sintomaDTO
	 *            the sintomaDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the new
	 *         sintomaDTO, or with status 400 (Bad Request) if the sintoma has
	 *         already an ID
	 ...
	 *
	 * @param sintomaDTO
	 *            the sintomaDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         sintomaDTO, or with status 400 (Bad Request) if the sintomaDTO is not
	 *         valid, or with status 500 (Internal Server Error) if the sintomaDTO
	 *         couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	...
	public ResponseEntity<SintomaDTO> updateSintoma(@RequestBody SintomaDTO sintomaDTO) throws URISyntaxException {
		...
		return ResponseEntity.ok()
				.headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, sintomaDTO.getId().toString())).body(result);
	}
	 ...
	 * @return the ResponseEntity with status 200 (OK) and the list of sintomas in
	 *         body
	 */
	@GetMapping("/sintomas")
	@Timed
	 ...
	 *
	 * @param id
	 *            the id of the sintomaDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the sintomaDTO,
	 ...
	 *
	 * @param id
	 *            the id of the sintomaDTO to delete
