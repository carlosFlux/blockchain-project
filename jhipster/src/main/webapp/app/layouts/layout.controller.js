(function() {
    ...
    ContextController.$inject = ['$timeout', '$state', '$stateParams', '$scope', 'Auth', 'Principal', 'ProfileService','LoginService'];

    function ContextController ($timeout, $state, $stateParams, $scope, Auth, Principal, ProfileService, LoginService) {
