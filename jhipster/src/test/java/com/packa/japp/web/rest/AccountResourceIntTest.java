...
import com.packa.japp.domain.Authority;
import com.packa.japp.domain.PersistentToken;
import com.packa.japp.domain.User;
import com.packa.japp.repository.AuthorityRepository;
import com.packa.japp.repository.PersistentTokenRepository;
import com.packa.japp.repository.UserRepository;
import com.packa.japp.security.AuthoritiesConstants;
import com.packa.japp.service.MailService;
import com.packa.japp.service.dto.UserDTO;
import com.packa.japp.web.rest.errors.ExceptionTranslator;
import com.packa.japp.web.rest.vm.KeyAndPasswordVM;
import com.packa.japp.web.rest.vm.ManagedUserVM;
import com.packa.japp.service.UserService;
...
public class AccountResourceIntTest {
	...
	public void testGetCurrentSessions() throws Exception {
		...
		restMvc.perform(get("/api/account/sessions")).andExpect(status().isOk())
