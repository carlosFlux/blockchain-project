...
public class HistoriaClinicaResourceIntTest {
	...
	public void createHistoriaClinica() throws Exception {
		...
		restHistoriaClinicaMockMvc
				.perform(post("/api/historia-clinicas").contentType(TestUtil.APPLICATION_JSON_UTF8)
	...
	public void getAllHistoriaClinicas() throws Exception {
		...
		restHistoriaClinicaMockMvc.perform(get("/api/historia-clinicas?sort=id,desc")).andExpect(status().isOk())
	...
	public void updateHistoriaClinica() throws Exception {
		...
		// Disconnect from session so that the updates on updatedHistoriaClinica are not
		...
		restHistoriaClinicaMockMvc.perform(put("/api/historia-clinicas").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(historiaClinicaDTO))).andExpect(status().isOk());
	...
	public void updateNonExistingHistoriaClinica() throws Exception {
		...
		// updated
		restHistoriaClinicaMockMvc
				.perform(put("/api/historia-clinicas").contentType(TestUtil.APPLICATION_JSON_UTF8)
						.content(TestUtil.convertObjectToJsonBytes(historiaClinicaDTO)))
				.andExpect(status().isCreated());
	...
	public void deleteHistoriaClinica() throws Exception {
		...
		// Get the historiaClinica
		restHistoriaClinicaMockMvc.perform(
				delete("/api/historia-clinicas/{id}", historiaClinica.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
